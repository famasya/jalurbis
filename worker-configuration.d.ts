/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9d28d0d89f45d64b2ea91cec1b776914)
// Runtime types generated with workerd@1.20251105.0 2025-09-24 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SECRET_KEY_GPS_SOCKET: string;
		SECRET_KEY_MAIN: string;
		SECRET_KEY_PTIS: string;
		API_BASE_URL: string;
		GPS_API_BASE_URL: string;
		X_TOKEN: string;
		KEMENHUB_BASE_API: string;
		GPS_STREAM_BASE_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET_KEY_GPS_SOCKET" | "SECRET_KEY_MAIN" | "SECRET_KEY_PTIS" | "API_BASE_URL" | "GPS_API_BASE_URL" | "X_TOKEN" | "KEMENHUB_BASE_API" | "GPS_STREAM_BASE_URL">> {}
}
