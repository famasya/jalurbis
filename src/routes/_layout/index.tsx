...
import { tokenHooks, socketTokenHooks } from "~/hooks/token-hooks"
...
function ClientOnlyMap({
  ...
  useEffect(() => {
    ...
    import('~/components/map/TransportMap').then((mod) => {
  ...
  return <MapComponent corridors={corridors} vehicles={vehicles} center={center} zoom={zoom} />
}
...
function RouteComponent() {
  ...
  const mapZoom = selectedTrans ? parseInt(selectedTrans.zoom) : 12
